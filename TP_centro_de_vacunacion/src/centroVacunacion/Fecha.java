...
public class Fecha implements Comparable<Fecha> {
	...
	public static int diferenciaAnios(Fecha hoy, Fecha fNacimiento) {
		...
		int edad = hoy.anio() - fNacimiento.anio();
		return edad;
	}
	...
	public Fecha sumar(int dias) {
		LocalDate f = fecha.plusDays(dias);
		return (new Fecha(f.getDayOfMonth(),f.getMonthValue(), f.getYear()));
	}
