...
public class TestCentroVacunacion {
	...
	public void testGenerarYConsultarTurnos() {
		Fecha fechaInicial = new Fecha(12, 7, 2021);
		Fecha fechaSiguiente = new Fecha(13, 7, 2021);
		Fecha fechaAnteriorSinTurnos = new Fecha(11, 7, 2021);
		Fecha fechaPosteriorSinTurnos = new Fecha(14, 7, 2021);
	...
	public void testGenerarTurnosYRegistrarVacunacion() {
		...
		Fecha fecha = new Fecha(11,7,2021);
		assertEquals(20, centro.vacunasDisponibles());
		...
		// lista de espera.
		Fecha.setFechaHoy(13, 7, 2021);

		centro.generarTurnos(new Fecha(16,7,2021));
	...
	public void testVacunarPersonaConTurnoParaOtraFecha() {
		int dniAVacunar=29959000;
		Fecha fecha = new Fecha(10,7,2021);
		Fecha fechaIncorrecta = new Fecha(9,7,2021);
		centro.generarTurnos(fecha);
